    ...
    return (
        <div className='home flex flex-col items-center my-4 mx-10 gap-4 relative'>
            ...
            <div className='home__header'>
                <img className="home__user absolute  cursor-pointer" onClick={() => navigate('/login')} src={user} alt="" />
                <h1 className='home__title font-bold'>OASIS</h1>
            </div>
            <div className='home__container w-full'>
                <div onClick={() => goProducts('Mujer')} className='home__category relative flex justify-center'>
                ...
                <div onClick={() => goProducts('Hombre')} className='home__category relative flex justify-center'>
                ...
                <div onClick={() => goProducts('Niños')} className='home__category relative flex justify-center'>
                ...
                <div onClick={() => goProducts('Hogar')} className='home__category relative flex justify-center'>
